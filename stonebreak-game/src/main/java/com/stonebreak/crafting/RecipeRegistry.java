...
public final class RecipeRegistry {
    ...
    public static void registerAll(CraftingManager craftingManager) {
        ...
        // Recipe 29: Dagger
        List<List<ItemStack>> daggerPattern = Arrays.asList(
            Arrays.asList(null, new ItemStack(BlockType.COBBLESTONE.getId(), 1)),
            Arrays.asList(new ItemStack(ItemType.STICK, 1), null)
        );
        craftingManager.registerRecipe(new Recipe(
            "dagger",
            daggerPattern,
            new ItemStack(ItemType.DAGGER, 1)
        ));
        System.out.println("Registered recipe: COBBLESTONE + STICK -> DAGGER");

        // Recipe 30: Dagger (mirrored)
        List<List<ItemStack>> daggerMirroredPattern = Arrays.asList(
            Arrays.asList(new ItemStack(BlockType.COBBLESTONE.getId(), 1), null),
            Arrays.asList(null, new ItemStack(ItemType.STICK, 1))
        );
        craftingManager.registerRecipe(new Recipe(
            "dagger_mirrored",
            daggerMirroredPattern,
            new ItemStack(ItemType.DAGGER, 1)
        ));
        System.out.println("Registered recipe: COBBLESTONE + STICK (mirrored) -> DAGGER");

        // Recipe 31: Staff (Leaves)
        List<List<ItemStack>> staffLeavesPattern = Arrays.asList(
            Arrays.asList(null, null, new ItemStack(ItemType.STICK, 1)),
            Arrays.asList(new ItemStack(BlockType.LEAVES.getId(), 1), new ItemStack(ItemType.STICK, 1), new ItemStack(BlockType.LEAVES.getId(), 1)),
            Arrays.asList(new ItemStack(ItemType.STICK, 1), null, null)
        );
        craftingManager.registerRecipe(new Recipe(
            "staff_leaves",
            staffLeavesPattern,
            new ItemStack(ItemType.STAFF, 1)
        ));
        System.out.println("Registered recipe: LEAVES + STICKS -> STAFF");

        // Recipe 32: Staff (Leaves, mirrored)
        List<List<ItemStack>> staffLeavesMirroredPattern = Arrays.asList(
            Arrays.asList(new ItemStack(ItemType.STICK, 1), null, null),
            Arrays.asList(new ItemStack(BlockType.LEAVES.getId(), 1), new ItemStack(ItemType.STICK, 1), new ItemStack(BlockType.LEAVES.getId(), 1)),
            Arrays.asList(null, null, new ItemStack(ItemType.STICK, 1))
        );
        craftingManager.registerRecipe(new Recipe(
            "staff_leaves_mirrored",
            staffLeavesMirroredPattern,
            new ItemStack(ItemType.STAFF, 1)
        ));
        System.out.println("Registered recipe: LEAVES + STICKS (mirrored) -> STAFF");

        // Recipe 33: Staff (Pine Leaves)
        List<List<ItemStack>> staffPineLeavesPattern = Arrays.asList(
            Arrays.asList(null, null, new ItemStack(ItemType.STICK, 1)),
            Arrays.asList(new ItemStack(BlockType.PINE_LEAVES.getId(), 1), new ItemStack(ItemType.STICK, 1), new ItemStack(BlockType.PINE_LEAVES.getId(), 1)),
            Arrays.asList(new ItemStack(ItemType.STICK, 1), null, null)
        );
        craftingManager.registerRecipe(new Recipe(
            "staff_pine_leaves",
            staffPineLeavesPattern,
            new ItemStack(ItemType.STAFF, 1)
        ));
        System.out.println("Registered recipe: PINE_LEAVES + STICKS -> STAFF");

        // Recipe 34: Staff (Pine Leaves, mirrored)
        List<List<ItemStack>> staffPineLeavesMirroredPattern = Arrays.asList(
            Arrays.asList(new ItemStack(ItemType.STICK, 1), null, null),
            Arrays.asList(new ItemStack(BlockType.PINE_LEAVES.getId(), 1), new ItemStack(ItemType.STICK, 1), new ItemStack(BlockType.PINE_LEAVES.getId(), 1)),
            Arrays.asList(null, null, new ItemStack(ItemType.STICK, 1))
        );
        craftingManager.registerRecipe(new Recipe(
            "staff_pine_leaves_mirrored",
            staffPineLeavesMirroredPattern,
            new ItemStack(ItemType.STAFF, 1)
        ));
        System.out.println("Registered recipe: PINE_LEAVES + STICKS (mirrored) -> STAFF");

        // Recipe 35: Staff (Elm Leaves)
        List<List<ItemStack>> staffElmLeavesPattern = Arrays.asList(
            Arrays.asList(null, null, new ItemStack(ItemType.STICK, 1)),
            Arrays.asList(new ItemStack(BlockType.ELM_LEAVES.getId(), 1), new ItemStack(ItemType.STICK, 1), new ItemStack(BlockType.ELM_LEAVES.getId(), 1)),
            Arrays.asList(new ItemStack(ItemType.STICK, 1), null, null)
        );
        craftingManager.registerRecipe(new Recipe(
            "staff_elm_leaves",
            staffElmLeavesPattern,
            new ItemStack(ItemType.STAFF, 1)
        ));
        System.out.println("Registered recipe: ELM_LEAVES + STICKS -> STAFF");

        // Recipe 36: Staff (Elm Leaves, mirrored)
        List<List<ItemStack>> staffElmLeavesMirroredPattern = Arrays.asList(
            Arrays.asList(new ItemStack(ItemType.STICK, 1), null, null),
            Arrays.asList(new ItemStack(BlockType.ELM_LEAVES.getId(), 1), new ItemStack(ItemType.STICK, 1), new ItemStack(BlockType.ELM_LEAVES.getId(), 1)),
            Arrays.asList(null, null, new ItemStack(ItemType.STICK, 1))
        );
        craftingManager.registerRecipe(new Recipe(
            "staff_elm_leaves_mirrored",
            staffElmLeavesMirroredPattern,
            new ItemStack(ItemType.STAFF, 1)
        ));
        System.out.println("Registered recipe: ELM_LEAVES + STICKS (mirrored) -> STAFF");
