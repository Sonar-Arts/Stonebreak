...
/**
 * Per-column terrain profile (heights + water levels + biomes) computed once during terrain
 ...
 */
public record ColumnProfile(int[] heights, int[] waterLevels, BiomeType[] biomes) {
