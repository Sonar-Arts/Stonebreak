 ...
 * is at or below sea level. No climate filtering, no grid calculation - just pure ocean filling.</p>
 *
...
public class SeaLevelCalculator {
     ...
     *
     * <p>Returns seaLevel if terrain is at or below sea level, otherwise -1 (no water).</p>
     *
     ...
     * </pre>
     *
     * @param terrainHeight Terrain height (first air Y-coordinate) at this column
