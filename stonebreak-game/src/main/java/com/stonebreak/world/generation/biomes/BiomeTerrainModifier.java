...
public interface BiomeTerrainModifier {
     ...
     *
     * This is called AFTER terrain hint generation in the two-pass system:
     * Pass 1: HeightMapGenerator applies terrain hints (mesa, peaks, etc.)
     ...
     *
     * @param baseHeight The height generated by HeightMapGenerator
