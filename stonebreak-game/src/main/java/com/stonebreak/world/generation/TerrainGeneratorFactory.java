...
public class TerrainGeneratorFactory {
     ...
     */
    public static TerrainGenerator create(TerrainGeneratorType type, long seed, TerrainGenerationConfig config) {
        if (type == null) {
        ...
        return switch(type) {
            ...
            case SPLINE -> new SplineTerrainGenerator(seed, config);
        };
    }
     ...
     */
    public static TerrainGenerator createFromString(String typeString, long seed, TerrainGenerationConfig config) {
        if (config == null) {
            throw new NullPointerException("Config cannot be null");
        }
