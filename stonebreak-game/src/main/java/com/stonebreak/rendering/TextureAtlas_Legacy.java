...
/**
 * Legacy texture loading and management system (BACKUP COPY).
 * This is the original hardcoded texture atlas system, preserved for reference.
 * DO NOT USE - Use the new TextureAtlas.java instead.
 */
public class TextureAtlas_Legacy {
     ...
     */
    public TextureAtlas_Legacy(int textureSize) {
