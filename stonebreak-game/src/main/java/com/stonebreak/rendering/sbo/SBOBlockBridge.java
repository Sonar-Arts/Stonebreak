...
public class SBOBlockBridge {
    ...
    // Render layer / transparency resolution lives in
    // com.stonebreak.blocks.BlockRenderTraits (read via BlockType) — the
    // SBO manifest plus authored face materials, resolved once at registry load.
}
