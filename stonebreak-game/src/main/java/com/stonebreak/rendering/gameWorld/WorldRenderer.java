...
public class WorldRenderer {
    ...
    private void renderPlayerArm(Player player) {
        ...
        if (currentState == GameState.PLAYING || currentState == GameState.INVENTORY_UI || currentState == GameState.CHARACTER_SHEET_UI || currentState == GameState.RECIPE_BOOK_UI || currentState == GameState.WORKBENCH_UI) {
