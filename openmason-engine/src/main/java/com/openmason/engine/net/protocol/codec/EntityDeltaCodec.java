...
/**
 * Fixed-point conversion helpers for compact entity-move deltas.
 *
 * <p>Position is encoded as {@code short = round(blocks * 4096)} → ±8 blocks per packet at
 * ~0.00024-block resolution. Yaw is encoded as {@code short = round(degrees * 10)} →
 * ±3276° at 0.1° resolution.
 *
 * <p>Ported verbatim from the game's legacy {@code sync.EntityDeltaCodec}.
 */
