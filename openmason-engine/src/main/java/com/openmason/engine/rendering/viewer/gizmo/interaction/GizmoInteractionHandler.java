...
public class GizmoInteractionHandler {
    ...
    /**
     * Set where completed model-level drags are reported for undo.
     */
    ...
    public void handleMouseMove(float mouseX, float mouseY, List<GizmoPart> gizmoParts) {
        ...
        if (gizmoState.isDragging()) {
            dragHandler.updateState(snapSettings, transformTarget);
    ...
    public boolean handleMousePress(float mouseX, float mouseY) {
        ...
        if (hoveredPart != null) {
            ...
            if (target != null) {
                ...
                if (transformTarget != null && transformTarget.supportsGroupFallback()) {
                    transformTarget.beginGroupDrag();
                }
    ...
    public void handleMouseRelease(float mouseX, float mouseY) {
        ...
        if (gizmoState.isDragging()) {
            ...
            // Release any snapshots the target took at drag start
            if (activeTarget != null) {
                activeTarget.endDrag();
            }
