...
public class ArcballCameraController implements CameraController {
    ...
    /**
     * Moves the orbit pivot. Distance, yaw and pitch are unchanged, so the camera
     * keeps its current framing and simply orbits a different point — which is what
     * restoring a saved view needs.
     */
    @Override
