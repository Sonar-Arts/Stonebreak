...
public class DragHandler {
     ...
     */
    public void updateState(SnapSettings snapSettings, ITransformTarget transformTarget) {
    ...
    private void handleTranslateDrag(Vector2f mouseDelta, AxisConstraint constraint,
        ...
        transformApplier.applyPosition(newPos, activeTarget, transformTarget, startPos, snapSettings);
    }
