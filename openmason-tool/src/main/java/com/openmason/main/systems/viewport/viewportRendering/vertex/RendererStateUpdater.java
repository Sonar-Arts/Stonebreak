...
public class RendererStateUpdater {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RendererStateUpdater.class);
    ...
    public static class UpdateContext {
        ...
        public UpdateContext(float[] allMeshVertices,
     ...
     */
    public RendererStateUpdater(UpdateContext context,
    ...
    public UpdateContext applyMergeResult(VertexMerger.MergeResult mergeResult) {
        ...
        if (context.allMeshVertices != null) {
            meshMappingRebuilder.rebuild(mergeResult.newVertexPositions, context.allMeshVertices);
