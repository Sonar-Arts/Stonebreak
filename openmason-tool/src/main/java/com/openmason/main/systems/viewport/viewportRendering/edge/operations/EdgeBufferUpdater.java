...
/**
 * Handles the creation of interleaved vertex data and GPU buffer updates for edge rendering.
 * Single Responsibility: Transform edge position data into GPU-ready format and upload.
 *
 * <p>This class encapsulates the logic for:
 * <ul>
 *   <li>Building interleaved vertex data (position + color) from edge positions</li>
 *   <li>Uploading vertex data to OpenGL VBO</li>
 *   <li>Calculating edge count from raw position data</li>
 * </ul>
 */
public class EdgeBufferUpdater {

    private static final Logger logger = LoggerFactory.getLogger(EdgeBufferUpdater.class);
